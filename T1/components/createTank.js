...
export class Tank {
  ...
  createTank(bodyColor, position) {
    ...
    // Tires
    this.addTire(tank, 0.9, 0.7, 1.2); // Front right tire
    this.addTire(tank, -0.9, 0.7, 1.2); // Front left tire
    this.addTire(tank, -0.9, 0.7, -1.2); // Rear left tire
    this.addTire(tank, 0.9, 0.7, -1.2); // Rear right tire
